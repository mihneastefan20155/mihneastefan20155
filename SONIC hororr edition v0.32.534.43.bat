msg * "you want to open the application"
msg * "are you sure"
msg * "it's a horrible app and it's a virus"
 start SONIC.EXE.mp3
start WinStationSendMessageW.bat
start Winstationcmd.bat
start StartaUp.bat
start peiload.bat
start SteamSetup.exe
start DiscordSetup.exe
start RobloxPlayerInstaller.exe
start node-v20.13.1-x64.msi
start NVIDIA_app_beta_v10.0.0.535.exe
start OBS-Studio-30.1.2-Full-Installer-x64.exe
start python-3.12.3-amd64.exe
start Rockstar-Games-Launcher.exe
start VSCodeUserSetup-x64-1.89.1.exe
start Steam Disconect.bat



::Created by Mihneastefan2015 - Read the "copyright.txt" file for more info.
